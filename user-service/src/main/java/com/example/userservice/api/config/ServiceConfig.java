package com.example.userservice.api.config;

import com.example.userservice.api.config.exception.CoustomHandlerExceptionResolver;
import feign.Logger;
...
public class ServiceConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(new LoginCheckInterceptor(jwtTokenProvider))
                ...
                .addPathPatterns("/**")
                .excludePathPatterns(
                        "/login", "/error", "/signup", "/health_check", "/actuator/**", "/h2-console/**", "/v3/**"
                );
    }
