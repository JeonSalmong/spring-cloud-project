...
//@Component
@Slf4j
public class AuthenBeforeAspect implements MethodInterceptor {
	@Override
	public Object invoke(MethodInvocation invocation) throws Throwable {
		log.debug("[AopAuthenBeforeLoggin authenLogInsertPolicyLogoutBefore]");

//		if (authenLog != null) {
//			authenLog.insertPolicyLogoutBefore(invocation);
//		}
